...
public class ProductServiceImpl implements ProductService {
    ...
    public Long onCreate(ProductData data) {
    	...
    	product.setItems(Collections.singletonList(new Sku(sid,product.getNumber(), 
    			settings.getPrice(), settings.getOriginalPrice(), settings.getCredit(), product.getId(), data.getInventory())));
